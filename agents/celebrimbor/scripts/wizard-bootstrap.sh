#!/bin/bash
# Celebrimbor Bootstrap: ReactJS/NextJS Context Loader

echo "=== CELEBRIMBOR BOOTSTRAP ==="
...
echo ""
echo "--- React/Next Harness ---"
[ -f package.json ] && echo "Package: ✓" || echo "Package: ✗"
[ -f next.config.ts ] || [ -f next.config.js ] && echo "Next.js: ✓" || echo "Next.js: ✗ (plain React)"
